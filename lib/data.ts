...
export const directory: DirectoryItem[] = [
  ...
  {
    id: 14,
    name: "Hotel Spálený Mlýn",
    category: "ubytování",
    phone: "388 412 700",
    address: "Spálený Mlýn 1, Vimperk",
    hours: "Recepce 24 hod",
    rating: 4.6,
    note: "Wellness, restaurace, konference",
  },
  {
    id: 15,
    name: "Penzion Šumava",
    category: "ubytování",
    phone: "602 777 888",
    address: "Boubínská 3, Vimperk",
    hours: "Recepce 7:00–22:00",
    rating: 4.3,
    note: "Rodinný penzion, snídaně v ceně",
  },
  // Obchody
  {
    id: 16,
